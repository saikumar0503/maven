        ...
        stage('Deploy to Dev') {
            steps {
                sshagent(['IAS-one']) {
                    ...
                    sh'ssh ec2-user@172.16.10.251 /home/ec2-user/apache-tomcat-9.0.46/bin/shutdown.sh'
                    sh'ssh ec2-user@172.16.10.251 /home/ec2-user/apache-tomcat-9.0.46/bin/startup.sh'
                }
            }
        }
    }
